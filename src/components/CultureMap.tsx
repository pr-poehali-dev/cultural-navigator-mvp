...
const culturePoints: CulturePoint[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1564372694889-5002ac2828c0?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aGVybWl0YWdlfGVufDB8fDB8fHww",
    location: { x: 45, y: 35 },
    category: "museum"
  },
  {
    id: 2,
    name: "Большой театр",
    description: "Один из крупнейших театров оперы и балета России, историческая сцена и символ российской культуры.",
    image: "https://images.unsplash.com/photo-1556281167-46e8d9db5af1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Ym9sc2hvaXxlbnwwfHwwfHx8MA%3D%3D",
    location: { x: 65, y: 25 },
    category: "theater"
  },
  {
    id: 3,
    name: "Мамаев курган",
    description: "Мемориальный комплекс на месте ожесточённых боёв во время Сталинградской битвы.",
    image: "https://images.unsplash.com/photo-1576420252689-53311cad261e?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHZvbGdvZ3JhZHxlbnwwfHwwfHx8MA%3D%3D",
    location: { x: 20, y: 70 },
    category: "monument"
  }
];
  ...
  return (
    <div className="relative">
      ...
      <div className="bg-muted rounded-lg relative w-full h-[400px] overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1580931733435-78b8ff641e74?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3')] bg-cover opacity-30"></div>
          ...
          <CardHeader className="pb-2">
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription>{categoryIcons[selectedPoint.category]} {selectedPoint.category}</CardDescription>
              </div>
              <button 
